...
struct spi_statistics {
	raw_spinlock_t		lock; /* lock for the whole structure */
...
#define SPI_MASTER_GPIO_SS		BIT(5)	/* GPIO CS must select slave */
	...
	raw_spinlock_t		bus_lock_spinlock;
...
struct spi_message {
	...
	/* real-time signaling message transfer done */
	struct swait_queue_head swait;
